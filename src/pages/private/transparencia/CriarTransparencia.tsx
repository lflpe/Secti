...
export const CriarTransparencia = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Exemplo: await api.post('/transparencia', formData)

      // Simular espera
      await new Promise(resolve => setTimeout(resolve, 1000));

      setSucesso('Documento de transparência criado com sucesso!');
      ...
      const mensagemErro = error instanceof Error ? error.message : 'Erro ao criar documento de transparência';
    ...
    <PrivateLayout>
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Novo Documento de Transparência</h1>
            <p className="text-gray-600 mt-2">Preencha os campos abaixo para criar um novo documento de transparência</p>
          </div>
          <button
            type="button"
        ...
        <form onSubmit={handleSubmit} className="bg-white shadow-sm rounded-lg border border-gray-200 p-6 space-y-6">
          ...
          <div>
            <label htmlFor="arquivo-input" className="block text-sm font-medium text-gray-700 mb-2">
              Selecione o Arquivo de Transparência <span className="text-red-500">*</span>
            </label>
